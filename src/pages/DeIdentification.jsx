...
const MedicalDocument = ({ data, isNested = false, rootData = null }) => {
  ...
  const formatValue = (k, v) => {
    const sensitiveKeys = ['patientName', 'patientPhone', 'patientAddress', 'patientDateOfBirth', 'patientSSNLast4', 'email', 'medicalHistory', 'incidentLocation', 'incidentDescription', 'diagnosis', 'treatmentProvided', 'treatmentPlan', 'age', 'height', 'weight', 'bloodGroup', 'doctor', 'currentMedicines', 'comorbidity', 'allergy', 'spo2', 'heartRate', 'respirationRate', 'bloodSugar', 'diastolicBp', 'systolicBp', 'pulseRate', 'temperature', 'hemoglobin', 'incidentNumber', 'sceneAssessment', 'crew', 'timeline', 'structuredComplaints', 'structuredVitals', 'icd10Code', 'primaryImpression', 'secondaryImpression', 'structuredMedications', 'structuredProcedures', 'transport', 'consent', 'clinicalData', 'attachmentIds', 'auditTrail', 'feedback'];
